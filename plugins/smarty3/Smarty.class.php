...
//            ->setConfigDir('.' . DS . 'configs' . DS);
        ...
        $this->setTemplateDir(PLUGINS_SMARTY3_TEMPLATE_DIR . DS)
            ->setCompileDir(PLUGINS_SMARTY3_COMPILE_DIR . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir(PLUGINS_SMARTY3_CACHE_DIR . DS)
            ->setConfigDir(PLUGINS_SMARTY3_CONFIG_DIR . DS);
